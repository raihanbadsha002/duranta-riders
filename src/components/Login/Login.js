...
import './Login.css';
import googleImg from '../../images/goo.png';
    ...
    <div className="row d-flex justify-content-center align-items-center mt-lg-4">
      ...
      <div className="card-title">
        <h3> {newUser ? "Create an account" : "Login"}</h3> 
         ...
         <form onSubmit={handleSubmit}>
          ...
          <p className="text-center">{newUser ? "Already have an account?" : "Don't have an account?"} <span className="text-danger login__create" onClick={() => setNewUser(!newUser)}>{newUser ? "Login" : "Create an account"}</span></p>
     </div>
     <div className="div text-center mt-2">
      ...
      <div className="my-3 d-flex justify-content-center">
            <button className="btn btn-outline-success mx-2 rounded-pill my-2 text-center" onClick={handelGoogleSignIn}> <img src={googleImg} alt="Google"/> Continue with Google</button> <br/>
            <button className="btn btn-outline-success mx-2 rounded-pill my-2 text-center" onClick={handelFacebookSignIn}> <img src={fbImg} alt="Facebook"/> Continue with Facebook</button>
      </div>
     </div>
    </div>
